...
> 불편해도 사람들은 이미 나름대로 하고 있습니다. 카톡 검색, 엑셀,
> 대충 하고 넘어가기, 그냥 포기하기 — **도구가 아니어도 답입니다.**
> 그 방법이 우리의 진짜 경쟁 상대입니다. 확인할 때 함께 물어보세요.

- **지금은 어떻게 하고 있는가** (도구가 없으면 "그냥 포기한다"도 답): 
- **그래서 충분한가** — 충분하지 않다면 무엇이 부족한가: 

> 두 번째 칸을 못 쓰면 아직 만들 이유가 없는 것입니다.
> 발표에서 **"그거 노션 쓰면 되지 않나요?"**는 거의 반드시 나옵니다.
